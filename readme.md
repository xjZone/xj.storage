...
**协议** : [Apache License 2.0](https://github.com/xjZone/xj.storage/blob/master/LICENSE)  

————

**推荐阅读 :**  
XJ.Chen - [漫谈 WebStorage API 既本地存储的 8 个 Feature 以及 20 个 BUG](https://juejin.cn/post/7149305844360806414)  
